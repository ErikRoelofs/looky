function mainview()
  ...
  local imageLayout = lc:build("image", {width = "wrap", height = "wrap", backgroundColor = {0, 0, 255, 200}, file = "test.png", margin = lc.margin(25,30,0,0), padding = lc.padding(25,25,10,5)})
  ...
  layout:addChild( lc:build("text", {width = "fill", height = 100, text = "list 1", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
  
  layout:addChild( lc:build("text", {width = "wrap", height = 100, text = "list 2", textColor = {255,0,0,255}, backgroundColor = {255,255,255,255}, padding = lc.padding(5,5,0,0), layoutGravity = "end"}) )
  
  layout:addChild( lc:build("text", {width = "fill", height = 100, text = "list 3", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
  layout:addChild( lc:build("text", {width = "fill", height = 100, text = "list 4", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
  ...
  subContainer:addChild( lc:build("text", {width = "fill", height = 100, text = "check", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
  subContainer:addChild( lc:build("text", {width = "fill", height = 100, text = "check", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
  subContainer:addChild( lc:build("text", {width = "fill", height = 100, text = "check", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
  subContainer:addChild( lc:build("text", {width = "fill", height = 100, text = "check", textColor = {255,0,0,255}, padding = lc.padding(5,5,0,0)}) )
...
function dialog()
  ...
  dialogview:addChild( lc:build( "text", { text = "Close", width = 400, height = "wrap", backgroundColor = { 0, 0, 255, 255 }, textColor = { 255,255,255,255 }, layoutGravity = "center", gravity = {"center","center"}, padding = lc.padding(0,5,0,5)} ) )
