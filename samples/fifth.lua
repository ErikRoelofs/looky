function mainview()
  ...
  root:addChild( lc:build("text", { width = "fill", height = "wrap", text = "Below!", border = { color = { 0, 255, 0, 255 }, thickness = 5 }, paddingTop = 5, paddingBottom = 5, paddingLeft = 5, paddingRight = 5 } ) )
